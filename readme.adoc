...
<2> A GitHub personal access token (see: https://docs.github.com/en/packages/learn-github-packages/about-github-packages#authenticating-to-github-packages[the GitHub documentation]) for an overview, or https://github.com/settings/tokens[click here] to generate a new personal token.
